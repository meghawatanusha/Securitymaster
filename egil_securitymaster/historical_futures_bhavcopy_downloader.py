...
class Daily_Report :
    ...
    def download(self,link) :
        c="~/chromedriver"        #enter the path for ChromeDriver
        driver=webdriver.Chrome(c)    
        driver.get(link)            #to get the website required
        
        select_report='//*[@id="h_filetype"]/option[2]'
        date='//*[@id="date"]'
        get_data='//*[@id="wrapper_btm"]/div[1]/div[3]/div/div[1]/div/div[4]/input[3]'
                               #to get the xpath
        ...
        while (date2 <= date1) :
            ...
            try :
                ...
                try:
                    ...
                    link_for_file='//*[@id="spanDisplayBox"]/table/tbody/tr[1]/td/a'
...
link='https://www.nseindia.com/products/content/derivatives/equities/archieve_fo.htm'
