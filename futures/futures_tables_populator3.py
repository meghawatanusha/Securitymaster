...
def main(args):
    ...
    #Create the database
    engine = create_engine('mysql+pymysql://egil_user:egil_user@egsecuritymaster.cvxyuzctu0dv.ap-south-1.rds.amazonaws.com:3306/eg11')
    #engine = create_engine('mysql+pymysql://bors_master:uJ!DicDu*7sW@bors-db1.inmu1.eglp.com:3306/futures')
    ...
    metadata.reflect(engine, only=['attributes1','instruments1','prices1','last_generated_egid1','futureseries1','open_interest_table1','futures_contract_table1'])
...
#    # ... or just define our own Table objects with it (or combine both)
 ...
 # we can then produce a set of mappings from this MetaData.
    ...
    last_generated_egid=Base.classes.last_generated_egid1
    #New_entries = Base.classes.new_entries
    Future_series = Base.classes.futureseries1
              ...
              for i in data:
                  ...
                  if (not(future_symbol in active_futures) and (future_query is not None and future_query.count() < 1)):
                      ...
                      fut_contract = Futures_contract_table(**{ 'future_id':future_egid,
                                          'nseticker':i[1],
                                          'future_series_id':underlying_query.attributevalue,
                                          'contract_size':i[10] ,
